  ...
  return (
    <>
      ...
      <div className="flex items-center my-6">
        <div
          className="border-t border-grey-800 grow mr-3"
          aria-hidden="true"
        />
        <div className="text-sm text-grey-400 italic">Or</div>
        <div
          className="border-t border-grey-800 grow ml-3"
          aria-hidden="true"
        />
      </div>
      {/* Social login */}
      <button className="btn-sm text-white bg-gradient-to-t from-pink-500 to-pink-400 hover:to-pink-500 w-full relative flex after:flex-1">
        <div className="flex-1 flex items-center">
          <svg
            className="w-4 h-4 fill-current text-pink-200 shrink-0"
            viewBox="0 0 16 16"
        ...
        <span className="flex-auto text-pink-50 pl-3">
