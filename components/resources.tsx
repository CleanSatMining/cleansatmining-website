        ...
        <div className="py-12 md:py-20">
          ...
          <div>
            ...
            <div className="mb-16">
              <div className="flex flex-wrap justify-center -m-2.5">
                <div className={`${category === "1" && "rotate-2"}`}>
                  <button
                    className={`relative font-medium px-3 py-1.5 bg-grey-700 rounded-full inline-flex m-2.5 group before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-grey-800 before:to-grey-800 before:rounded-full ${
                      category === "1"
                        ? "shadow-lg shadow-brand-500/25 before:via-grey-300"
                        : "before:via-grey-600"
                    }`}
                  ...
                  >
                    <div className="flex items-center justify-center">
                      <svg
                        className={`w-3 h-3 shrink-0 fill-grey-400 mr-2 ${
                      ...
                      <span
                        className={`transition duration-150 ease-in-out ${
                          category === "1"
                            ? "text-brand-500"
                            : "text-grey-400 group-hover:text-grey-300"
                        }`}
                      >
                        For Developers
                      </span>
            ...
            <div className="max-w-sm mx-auto sm:max-w-none grid gap-12 sm:grid-cols-2 md:grid-cols-4 sm:gap-x-6 sm:gap-y-8 items-start">
              {/* 1st Box */}
              <a
                className={`block relative before:content-[''] before:bg-grey-700 before:absolute before:-z-10 before:inset-0 p-6 group ${
                  !["1", "3", "4"].includes(category) && "hidden"
                }`}
                href="#0"
              >
                <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-grey-800 to-grey-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-grey-800 before:to-grey-800 before:via-grey-600 before:rounded-full">
                  <svg
                    className="fill-brand-500 group-hover:fill-grey-200 transition duration-150 ease-in-out"
                    width="26"
                    height="18"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <div className="font-title text-xl text-grey-100 font-semibold">
                  Neon Telegram
                </div>
              </a>
              {/* 2nd Box */}
