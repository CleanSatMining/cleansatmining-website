  ...
  return (
    <section className="relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-grey-800">
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-title mb-4">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none pt-4">
            ...
            >
              <div className="mb-6">
                ...
                <div className="font-title inline-flex items-baseline mb-2">
                  <span className="text-3xl font-medium text-grey-400">$</span>
                  <span className="text-4xl font-bold leading-7">49</span>
                  <span className="font-medium text-grey-400">/mo</span>
                </div>
                <div className="text-grey-400 mb-6">
                  For teams building apps for many public &amp; private users.
                </div>
                <a
                  className="btn-sm text-white bg-gradient-to-t from-brand-600 to-brand-400 hover:to-brand-500 w-full shadow-lg group"
                  href="#0"
                >
                  Start Free Trial{" "}
              ...
              <ul className="text-grey-400 space-y-3 grow">
            ...
            {/* Pricing table 2 */}
            <div
              className="relative flex flex-col h-full p-6 bg-grey-700"
              data-aos="zoom-out"
              data-aos-delay="100"
            >
